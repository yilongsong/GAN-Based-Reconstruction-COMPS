...
def parse_args():
    ...
    parser.add_argument('--scale', type=float, required=False, choices=[4,8,16,32], help='scale of the task: 4, 8, 16, or 32 for scale')
    parser.add_argument('--ratio', type=float, required=False, choices=[0.1,0.3,0.5,0.7], help='ratio of the task: 0.1, 0.3, 0.5, or 0.7')
