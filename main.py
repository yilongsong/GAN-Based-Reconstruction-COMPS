...
def parse_args():
    ...
    parser.add_argument('--kernel', type=int, required=False, choices=[1,9,51], help='kernel size for Blur: 1, 9, or 51')
    ...
    parser.add_argument('--test_folder', type=str, required=True, choices=['Half', 'Whole', 'Object', 'DarkHair', 'LightHair', 'NoHair', 'DarkSkin', 'LightSkin', 'Us'], help='folder of images that you want to run this model on')
