...
def parse_args():
    ...
    parser.add_argument('--test_folder', type=str, required=True, choices=['Half', 'Whole', 'Object', 'DarkHair', 'LightHair', 'NoHair', 'DarkSkin', 'LightSkin'], help='folder of images that you want to run this model on')
